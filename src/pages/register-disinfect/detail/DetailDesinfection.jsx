...
const DetailDesinfection = ({ setView }) => {
  ...
  const registerVehicleId = useSelector((state) => state.registerVehicle.registerVehicleId.data);
  ...
  const statusDesinfection = registerVehicleId[0]?.statusDesinfection?.[0] || {};
